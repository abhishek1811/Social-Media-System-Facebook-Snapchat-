...
<body id="body">
	<div id="content">
        ...
        <!-- - - - - - - - - - - - - - - - - - - - - - - - - - -->
  		<script>
			<?php
				$query=pg_query("Select s.sname,s.url,s.country,s.city,s.street,s.shopno,q.price From 
								(Select h.Storeid,avg(price) as price from havedresses h,images i , stores s where h.imgid=i.imgid and s.storeid=h.storeid group by h.storeid)q, Stores s where s.storeid=q.storeid order by price  limit 10;");
          ...
          //Need to get store photoes and put in upload folder and mypic/images?
  ...
  <script type="text/javascript" src="cheapestStoresShowCards.js"></script>

$(document).ready(function() {
	...
	$(".triangle").css('left', tabRectPosition.left + tabRectWidth + 1 + 'px');
	$(".triangle").css('top', tabRectPosition.top + 1 + 'px');
	
	$(".triangle-border").css('border-top', (tabRectHeight / 2) + 'px solid transparent');
	$(".triangle-border").css('border-left', (tabRectHeight / 2) + 'px solid #444');
	$(".triangle-border").css('border-bottom', (tabRectHeight / 2) + 'px solid transparent');
	$(".triangle-border").css('left', (tabRectPosition.left + tabRectWidth + 2) + 'px');
	$(".triangle-border").css('top', (tabRectPosition.top + 2) + 'px');
	
	$(".tab-text").css('margin-right', ($('.template-border').width() * 0.15) + 'px');

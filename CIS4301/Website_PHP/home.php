    ...
    <div id="window-overlay">
      ...
      <div id="photo-overlay">
          ...
          <div id="photo-overlay-holder">
            ...
            <div id="big-imgtag" class="bigtext">tag</div>
            <a href="" id="bigname" class="bigtext">asdf</a>
            <div id="big-imgdatetime" class="bigtext">datetime</div>
            <div id="big-imgprice" class="bigtext">price</div>
            <div id="big-imgstore" class="bigtext">store</div>
            <div id="big-imgcountry" class="bigtext">country</div>
            ...
            <div id="descrip" class="bigtext">Description:</div>
            <div id="big-imgdesc" class="bigtext">desc</div>
        </div>
